...
public class SPGPreferenceWriter implements ru.noties.spg.processor.Logger {
    ...
    public void write(PreferenceHolder preference) {
        ...
        // write constructor
        writeConstructor(builder, indent, prefClassName, preference.preferenceMode);
    ...
    private static void writeConstructor(StringBuilder builder, Indent indent, String className, int prefMode) {
        builder
                .append(indent)
                .append("public ")
                .append(className)
            ...
            if (type != null) {
                ...
                builder.append(indent)
                        ...
                        .append("if (s == null) {\n")
                            ...
                            .append("();\n")
                            .append(indent)
                            .append("SPGManager.addSerializer(")
                            .append(typeMirror.toString())
                            .append(".class, s);\n")
                            .append(indent.decrement())
                        .append("}\n")
